...
*(Note on Word Selection v2: Beginning at Game 260, answers are drawn via weighted selection over an expanded candidate pool `answers_v2` of 9,570 words, preserving the legacy 3,000-word list for games 0–259. See [`docs/wordlists.md`](wordlists.md).)*
